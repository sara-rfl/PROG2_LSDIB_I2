...
public class ProcessadorMedidas {
     ...
     *
     * O metodo solicita ao usuário a seleção de um paciente, o período de análise e chama o submenu responsável
     * por exibir ou recolher sinais vitais do paciente no período informado.
     *
    ...
    public static void processarMedidasGrupo(Scanner scanner, Hospital hospital) {
        List<Paciente> grupo = GestorPacientes.selecionarGrupoPacientes(scanner, hospital);
        if (!grupo.isEmpty()) {
